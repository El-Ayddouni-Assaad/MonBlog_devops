...
<head>
     ...
     <link rel="stylesheet" href="Contenu/css/owl.theme.default.min.css">
...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
                         ...
                         <div class="caption">
                              <div class="container">
                                   <div class="col-md-6 col-sm-12">
                                        ...
                                        <a href="../Contenu/blog-posts.html" class="section-btn btn btn-default">Read Blog</a>
                                   </div>
                              </div>
                         </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                         <div class="footer-info">
                              ...
                              <div class="footer_menu">
                                   <h2>Quick Links</h2>
                                   <ul>
                                        <li><a href="../Contenu/index.html">Home</a></li>
                                        <li><a href="../Contenu/about-us.html">About Us</a></li>
                                        <li><a href="../Contenu/terms.html">Terms & Conditions</a></li>
                                        <li><a href="../Contenu/contact.html">Contact Us</a></li>
                                   </ul>
                              </div>
                         </div>
                    </div>
     ...
     <script src="Contenu/js/smoothscroll.js"></script>
